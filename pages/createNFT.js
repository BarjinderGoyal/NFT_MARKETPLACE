...
const projectId="2MBMU18TB1GQ3V0ia5UCLWTllm9";
const projectSecret="46172797344c6d2abb17e6601fc56325";
...
export default function CreateItem(){
  ...
  async function onChange(e){
    ...
    //     }
    //   )
    //   const url=`https://azmarket.infura-ipfs.io/ipfs/${added.path}`
    //   setFileUrl(url)
    // }catch(error){
  ...
  async function createSale(url){
    ...
    // console.log(tx,"tx");
    // console.log(event.args[2],"args[2]");
